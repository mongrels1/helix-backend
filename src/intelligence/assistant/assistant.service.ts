...
- What is a performance-verified credential? An Open Badges 3.0 credential issued only on demonstrated competency against a calibrated standard — performance-verified, not completion-certified.`;
