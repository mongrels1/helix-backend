...
- What is a performance-verified credential? An Open Badges 3.0 credential issued only on demonstrated competency against a calibrated standard — performance-verified, not completion-certified. Everyday app use earns these badges automatically; an optional proctored Verified Credential ($99, scheduled at least 2 weeks out) is available for families who want a supervised assessment on record — request it at ${VERIFIED_CREDENTIAL_URL}.`;
